...
contract ERC721LuxyUser is OwnableUpgradeable, ERC721URIStorageUpgradeable, Mint721Validator {

    event CreateERC721LuxyUser(address owner, string name, string symbol);

    function __ERC721LuxyUser_init(string memory _name, string memory _symbol, address[] memory operators) external initializer {
        // _setBaseURI(baseURI);
